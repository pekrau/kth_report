...
BASEDIRPATH = os.path.expanduser("~/Nextcloud/Årsrapport 2022/Units reports")
BASEFILENAME = f"orders_Infrastructure_Unit_report_2022"
...
# Information from the file "Reporting Units 2022.xlsx"
PLATFORM_LOOKUP = {
